...
export const ServiceCard = ({ icon, title, subtitle, description, features }: ServiceCardProps) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="backdrop-blur-xl bg-background rounded-3xl p-6 max-w-[390px] w-full h-full flex flex-col shadow-lg hover:shadow-xl transition-all duration-300 border border-border"
    >
      {/* Icon and Title */}
