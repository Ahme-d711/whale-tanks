...
export default function ShinyButton({
  ...
  const compClasses = cn(
    ...
    "relative overflow-hidden group font-semibold uppercase tracking-wider rounded-2xl shadow-lg shadow-primary/20 transition-all hover:bg-blue-700 disabled:opacity-70 disabled:cursor-not-allowed"
  )
