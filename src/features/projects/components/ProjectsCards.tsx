...
export default function ProjectsCards() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl! mx-auto justify-items-start">
      ...
      <div className="backdrop-blur-xl bg-background rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-border flex items-center justify-center min-h-[300px] cursor-pointer group">
